...
final class AuthorizationServiceTests: BaseTests {
    ...
    func testSuccess() async throws {
        ...
        // MARK: WHEN
        let authenticationResult = try await connectionManager.authorise(authentication: Authentication(username: fakeUser, password: fakePassword))
    ...
    func testInvalidUserOrPassword() async throws {
        ...
        // MARK: WHEN
        do {
            _ = try await connectionManager.authorise(authentication: Authentication(username: fakeUser, password: fakePassword))
